...
class DiagramConnectionDefaultsEditableToolButton extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the HTML attributes of a ButtonGroup's button.
    * @param  $value
    * @return \Kendo\Dataviz\UI\DiagramConnectionDefaultsEditableToolButton
    */
    ...
    /**
    * Sets the click option of the DiagramConnectionDefaultsEditableToolButton.
    ...
    */
    ...
    /**
    * Sets the toggle option of the DiagramConnectionDefaultsEditableToolButton.
