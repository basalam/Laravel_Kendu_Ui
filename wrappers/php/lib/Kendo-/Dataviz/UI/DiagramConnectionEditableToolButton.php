...
class DiagramConnectionEditableToolButton extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the HTML attributes of a ButtonGroup's button.
    * @param  $value
    * @return \Kendo\Dataviz\UI\DiagramConnectionEditableToolButton
    */
    ...
    /**
    * Sets the click option of the DiagramConnectionEditableToolButton.
    ...
    */
    ...
    /**
    * Sets the toggle option of the DiagramConnectionEditableToolButton.
