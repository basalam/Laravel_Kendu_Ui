...
//>> Properties
    ...
    */
    ...
    /**
    * Adds DiagramConnectionEditableToolButton to the DiagramConnectionEditableTool.
    * @param \Kendo\Dataviz\UI\DiagramConnectionEditableToolButton|array,... $value one or more DiagramConnectionEditableToolButton to add.
    * @return \Kendo\Dataviz\UI\DiagramConnectionEditableTool
    */
    ...
    /**
    * Sets the click option of the DiagramConnectionEditableTool.
    ...
    */
    ...
    /**
    * Adds DiagramConnectionEditableToolMenuButton to the DiagramConnectionEditableTool.
    * @param \Kendo\Dataviz\UI\DiagramConnectionEditableToolMenuButton|array,... $value one or more DiagramConnectionEditableToolMenuButton to add.
    * @return \Kendo\Dataviz\UI\DiagramConnectionEditableTool
    */
    ...
    */
    ...
    /**
    * Sets the overflowTemplate option of the DiagramConnectionEditableTool.
    ...
    */
    ...
    /**
    * Sets the template option of the DiagramConnectionEditableTool.
    ...
    */
    ...
    /**
    * Sets the toggle option of the DiagramConnectionEditableTool.
