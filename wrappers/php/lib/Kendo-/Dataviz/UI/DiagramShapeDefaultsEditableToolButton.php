...
class DiagramShapeDefaultsEditableToolButton extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the HTML attributes of a ButtonGroup's button.
    * @param  $value
    * @return \Kendo\Dataviz\UI\DiagramShapeDefaultsEditableToolButton
    */
    ...
    /**
    * Sets the click option of the DiagramShapeDefaultsEditableToolButton.
    ...
    */
    ...
    /**
    * Sets the toggle option of the DiagramShapeDefaultsEditableToolButton.
