...
class DiagramConnectionDefaultsEditableToolMenuButton extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the HTML attributes of a menu button.
    * @param  $value
    * @return \Kendo\Dataviz\UI\DiagramConnectionDefaultsEditableToolMenuButton
    */
