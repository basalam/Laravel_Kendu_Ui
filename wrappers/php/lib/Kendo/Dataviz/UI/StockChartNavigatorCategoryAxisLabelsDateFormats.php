...
class StockChartNavigatorCategoryAxisLabelsDateFormats extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The format used when categoryAxis.baseUnit is set to "days".
    * @param string $value
    * @return \Kendo\Dataviz\UI\StockChartNavigatorCategoryAxisLabelsDateFormats
    */
