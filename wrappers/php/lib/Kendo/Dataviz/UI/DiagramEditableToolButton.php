...
class DiagramEditableToolButton extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the HTML attributes of a ButtonGroup's button.
    * @param  $value
    * @return \Kendo\Dataviz\UI\DiagramEditableToolButton
    */
    ...
    /**
    * Sets the click option of the DiagramEditableToolButton.
    ...
    */
    ...
    /**
    * Sets the toggle option of the DiagramEditableToolButton.
