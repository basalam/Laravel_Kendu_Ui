...
class StockChartNavigatorCategoryAxisAutoBaseUnitSteps extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The seconds unit steps.
    * @param array $value
    * @return \Kendo\Dataviz\UI\StockChartNavigatorCategoryAxisAutoBaseUnitSteps
    */
